...
function scroller() {
   ...
   */
  function position() {
    var sectionOffset=window.innerHeight*.75;
    //console.log("sectionOffset is "+sectionOffset);
    var pos = window.pageYOffset - sectionOffset - containerStart;
    //console.log("postion is "+pos);
    var sectionIndex = d3.bisect(sectionPositions, pos);
    sectionIndex = Math.min(sections.size() - 1, sectionIndex);
    //console.log("section index is: ");

...
var scrollVis = function() {
  ...
  var yPersonalUseScale = d3.scale.ordinal()
  ...
  setupVis = function(wordData, fillerCounts, histData) {
    ...
    g.append("text")
      ...
      .text("The Water Situation");

    g.selectAll(".openvis-title")
      .attr("opacity", 0);
            // count openvis title
    g.append("text")
      .attr("class", "sub-title secondvis-title")
      .attr("x", width / 2)
      .attr("y", height / 3)
      .text("6");
  ...
  setupSections = function() {
    ...
    activateFunctions[0] = teamIntroduction
    activateFunctions[1] = visIntroduction;
    activateFunctions[2] = waterSituation;
    activateFunctions[3] = stepBack;
    activateFunctions[4] = globalWater;
    activateFunctions[5] = highlightFreshWater;
    activateFunctions[6] = freshWater;
    activateFunctions[7] = freshWaterDivision;
    activateFunctions[8] = usableFreshWater;
    activateFunctions[9] = idealWaterContinents;
    activateFunctions[10] = realWaterContinents;
    activateFunctions[11] = waterDisparityIntroduction;
    activateFunctions[12] = personChart;
    activateFunctions[13] = dietIntro;
    activateFunctions[14] = averageAmericanDietSlide;
    activateFunctions[15] = slidersChart;
    activateFunctions[16] = creditsAndResources;
    activateFunctions[17] = endAndExplore;
    activateFunctions[18] = creditsAndResources;
    activateFunctions[19] = pennsylvania;
  ...
  function visIntroduction() {

   }

  function waterSituation() {
  ...
  function globalWater() {

    init_p001_globeWater();

  }
  function highlightFreshWater() {
    init_highlightFreshGlobalWater();
  }

 function freshWater() {

  init_p002_freshWater()

 }

  function freshWaterDivision() {

  init_p003_freshWaterDiv();

  }

  function usableFreshWater() {

  init_p004_AvailFreshWaterDiv()

  }

  function idealWaterContinents() {
    init_p005_WaterDisPerCapita_continents_ideal();
  }

  function realWaterContinents() {
    init_p006_WaterDisPerCapita_continents_real();

   }

function waterDisparityIntroduction () {
  clearsvg();
...
function averageAmericanDietSlide() {

  clearsvg();

}
function slidersChart() {
init_p();
}
function creditsAndResources() {

  
  var visDiv = document.getElementById('vis');
  if(visDiv==null) {
    //add the div below container and row and add a svg element inside it
    console.log("inside visDiv== null")
    var div=document.createElement("div");
    div.id='vis';
    var svg=document.createElement("svg");
    svg.id="svgContainer";
    div.appendChild(svg);
    document.getElementById("outerRow").appendChild(div);
